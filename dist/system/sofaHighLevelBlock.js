...
System.register(['angular', './sofaHighLevelBlock.tpl.js'], function (_export) {
    var angular;
    return {
        setters: [function (_angular) {
            angular = _angular['default'];
        }, function (_sofaHighLevelBlockTplJs) {}],
        execute: function () {
            'use strict';

            angular.module('sofaHighLevelBlock', []).directive('sofaHighLevelBlock', function () {
                return {
