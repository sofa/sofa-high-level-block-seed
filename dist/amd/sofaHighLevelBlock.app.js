...
define(['exports', 'angular', './sofaHighLevelBlock.js'], function (exports, _angular, _sofaHighLevelBlockJs) {
    'use strict';
    ...
    _angular2.module('sofaHighLevelBlock.app', ['sofaHighLevelBlock']).run();
});}(sofa, document));
